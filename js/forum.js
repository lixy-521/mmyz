...
const FIXED_POSTS = [
  {
    ...
    comments: [
      ...
      { id: "cj2009", text: "ltq2007 你最近研究什么呢，上次说在研究别的方向？" },
...
全部九成新，基本没怎么写。打包50元。`,
  ...
  {
    id: "post-7",
    title: "格致计划那个外聘顾问到底是什么来头",
    time: "11月9日 22:41",
    authorId: "cj2009",
    views: 521, replies: 8,
    body: `格致计划成果展示会，我去看了那篇官网文章，里面提到合作科研机构"北境神经工程研究院"，但顾问名字没有公开。\n\n我搜了一下这个机构，官网有，但内容极少，就几行介绍。联系方式是一个邮箱。\n\n"长期从事认知科学与神经接口技术研究"……这跟学校的"健康数据采集"感觉对不上。\n\n有没有人知道更多？`,
    comments: [
      { id: "zy2008", text: "我也搜了，那个研究院在工商系统里注册地址是一个商务楼，在狼堡市区。" },
      { id: "hj2009", text: "神经接口……这不就是那种接脑子的技术吗" },
      { id: "cj2009", text: "对，他的研究方向跟「健康数据采集」根本不是一回事。" },
      { id: "zt2008", text: "他去学校的时候从来不走正门，保安室那边没他的记录。" },
      { id: "cj2009", text: "你确定？" },
      { id: "zt2008", text: "我跟保安大叔熟，他说确实没有，但实验楼那边单独记录。" },
      { id: "ltq2007", text: "他有记录的。只是不在你能查到的地方。" },
      { id: "cj2009", text: "ltq2007 你怎么知道？你进系统了？" }
    ]
  },
